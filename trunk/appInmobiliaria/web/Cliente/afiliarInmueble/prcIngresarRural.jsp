    ...
    <body style="background-color: white; color: black;"><header>
        ...
        <%
            ...
            Calendar fecha = new GregorianCalendar();
                ...
                int numpiscinas = Integer.parseInt(request.getParameter("numpiscinas"));
                ctrlIngresarRural ctrlRural = new ctrlIngresarRural();
                Rural rural = new Rural(tipoInmueble, numpiscinas, banos, habitaciones);
                rural.setCodPropietario(codigoPropietario);
                rural.setPrecio(precio);
                rural.setDireccion(direccion);
                rural.setArea(area);
                ...
                if (res.equals("")) {%>
        <script>
        alert("Datos del inmueble rural correctos");
        </script>
