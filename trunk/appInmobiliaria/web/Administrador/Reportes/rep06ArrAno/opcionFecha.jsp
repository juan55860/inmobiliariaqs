...
<html>
    ...
    <center><form id="formulario" method="get" action="reporteArrendamientoAnos.jsp"  target="cargo3">
            <div class="ui-widget">
                <br>
                <br>
                <label><strong>Seleccione año inicial: </strong></label>
                ...
                <label><strong>Seleccione año final: </strong></label>
