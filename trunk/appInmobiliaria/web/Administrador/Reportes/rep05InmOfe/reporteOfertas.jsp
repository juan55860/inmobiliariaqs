...
<html>
    ...
    <body>
        ...
        <%
            ...
            inmuebles = cnn.buscarPorFecha("RO");
            float cantidadTotal = 0.f;


            cantidadTotal = cnn.buscarPorFecha2("OFE");
        ...
        <div id="example" class="k-content">
            ...
            <script>
                function createChart() {
                    ...
                    $("#chart").kendoChart({
                        title: {
                            text: "Reporte Inmuebles en Oferta"
                        },
                        legend: {
                            position: "top"
                        },
            ...
            <center><table cellspacing="1" cellpadding="0" border="1"> 
                    ...
                    <tr bgcolor="FF8000">
                        <td align="center">TOTAL EN OFERTA: </td>
                    ...
                    <tr> 
                        <td align="center"> 
                            <table cellspacing="3" cellpadding="3" border="1"> 
                                <tr>
                                    <td colspan="9" align="center" bgcolor="336699"><font color="#FFFFFF"><strong>Reporte Inmuebles en Oferta</strong></font></td>
                                </tr>
