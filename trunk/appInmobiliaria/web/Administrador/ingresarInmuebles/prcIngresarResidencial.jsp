    ...
    <body style="background-color: white; color: black;"><header>
        ...
        <%
            ...
            String tipoInmueble = request.getParameter("tipoInmueble");
                ...
                boolean parq = Boolean.valueOf(request.getParameter("parq"));
                ctrlIngresarResidencial ctrlResidencial = new ctrlIngresarResidencial();
                Residencial residencial = new Residencial(tipoInmueble, habitaciones, banos, numeroPisos, barrio, parq);
                residencial.setCodPropietario(codigoPropietario);
                residencial.setPrecio(precio);
                residencial.setDireccion(direccion);
                residencial.setArea(area);
                residencial.setEstado(estado);
                residencial.setDescripcion(descripcion);
                residencial.setEstrato(estrato);
                residencial.setPrioridad(prioridad);
