...
public class prioridad {
    ...
    /**
     * @return the estadocheck
     */
    public String getEstadocheck() {
        return estadocheck;
    }

    /**
     * @param estadocheck the estadocheck to set
     */
    public void setEstadocheck(String estadocheck) {
