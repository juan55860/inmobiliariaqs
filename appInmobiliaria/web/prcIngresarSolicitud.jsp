...
<html>
    ...
    <body style="background-color: white; color: black;"><header>
            <div>
                ...
                <nav>
                    <ul class="menu">
                        <li><a href="Administrador/ArrendamientosVentas/frmArrendamientosVentas.jsp">Financiera</a></li>
                        <li><a href="#" target="frdirect">Prioridad</a></li>
                        <li><a href="#" target="frdirect">Inmuebles</a></li>
                        <li><a class="current" href="Administrador/IngresarClientes/frmRegistrarCliente.jsp" >Clientes</a></li> 
                        <li><a href="Administrador/Administrador.jsp">Archivos</a></li>
                    </ul>
                </nav>
            </div>
        </header>                   
          
        <%  String codinmueble = request.getParameter("codinmueble");
            ...
            String resultado = ctrlSolicitud.insertarSolicitud(solicitud, codinmueble);
            if (resultado.equals("")) {%>  
        <script>
