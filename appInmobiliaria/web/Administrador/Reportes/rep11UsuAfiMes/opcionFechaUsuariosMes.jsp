...
<html>
    ...
    <center><form id="formulario" method="get" action="reporteUsuariosMes.jsp"  target="cargo3">
            <div class="ui-widget">
                <br>
                <br>
    ...
    <center> <iframe id="cargo3" name="cargo3" frameborder="0" width="1000" height="1000" scrolling="yes"></iframe></center>
