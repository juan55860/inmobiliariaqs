...
<html>
    ...
    <body>
        ...
        <%
            ...
            inmuebles = cnn.buscarPorFecha("RNV");
            ...
            <script>
                ...
                function createChart() {
                    ...
                    $("#chart").kendoChart({
                        title: {
                            position: "bottom",
                            text: "Reporte Inmuebles Pendientes Por Vender"
                        },
                        legend: {
                            visible: false
                        },
                        ...
                        series: [{
                                ...
                                startAngle: 150,
                                data: [{
                                        category: "Pendientes por Vender",
                                        value: porc,
                                        color: "#9de219"
                                    }, {
                                        category: "Vendidos",
                    ...
                    <tr> 
                        <td align="center"> 
                            <table cellspacing="3" cellpadding="3" border="1"> 
                                <tr>
                                    <td colspan="9" align="center" bgcolor="336699"><font color="#FFFFFF"><strong>Reporte Inmuebles Pendientes Por Vender</strong></font></td>
                                </tr>
