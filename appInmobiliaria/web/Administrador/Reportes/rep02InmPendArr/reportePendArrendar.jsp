...
<html>
    ...
    <body>
        ...
        <%
            ...
            inmuebles = cnn.buscarPorFecha("RNA");
        ...
        <div id="example" class="k-content">
            ...
            <script>
                function createChart() {
                    ...
                    $("#chart").kendoChart({
                        title: {
                            text: "Reporte Inmuebles Pendientes Por Arrendar"
                        },
                        legend: {
                            position: "top"
                        },
                        ...
                        series: [{
                                type: "pie",
                                data: [{
                                        category: "Pendientes Por Arrendar",
                                        value: porc
                                    }, {
                                        category: "Arrendados",
                                        value: 100 - porc
            ...
            <center><table cellspacing="1" cellpadding="0" border="1"> 
                    ...
                    <tr bgcolor="FF8000">
                        <td align="center">TOTAL PENDIENTES: </td>
                    ...
                    <tr> 
                        <td align="center"> 
                            <table cellspacing="3" cellpadding="3" border="1"> 
                                <tr>
                                    <td colspan="9" align="center" bgcolor="336699"><font color="#FFFFFF"><strong>Reporte Inmuebles Pendientes Por Arrendar</strong></font></td>
                                </tr>
