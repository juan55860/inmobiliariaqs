    ...
    <body>
        ...
        <%
            ...
            for (int i = 0; i < 12; i++) {
                ...
                tamaños[aux] = cnn.buscarMes(i + 1, Integer.parseInt(seleccion1), "INM");
                totalGanancia[aux] = cnn.buscarMesGanancia(i + 1, Integer.parseInt(seleccion1), "INM");
        ...
        <div id="example" class="k-content">
            ...
            <script>
                ...
                <%
                    ...
                    $("#chart").kendoChart({
                        title: {
                            text: "Reporte Inmuebles Afiliados por Mes del Año: " +<%=seleccion1%> 
                        },
                        legend: {
                            position: "bottom"
                        },
