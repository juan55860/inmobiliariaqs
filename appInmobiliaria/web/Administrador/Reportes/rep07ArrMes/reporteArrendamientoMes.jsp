    ...
    <body>
        ...
        <%
            ...
            for (int i = 0; i < 12; i++) {
                ...
                tamaños[aux] = cnn.buscarMes(i + 1, Integer.parseInt(seleccion1), "ARR");
                totalGanancia[aux] = cnn.buscarMesGanancia(i + 1, Integer.parseInt(seleccion1), "ARR");
        ...
        <div id="example" class="k-content">
            ...
            <script>
                ...
                <%
                    ...
                    $("#chart").kendoChart({
                        title: {
                            text: "Reporte Arrendamientos Por Mes del Año: " +<%=seleccion1%> 
                        },
                        legend: {
                            position: "bottom"
                        },
